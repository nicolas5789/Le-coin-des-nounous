...
<div id="explain" class="formulaire_profil">
    ...
    <p>Ca tombe bien, le Coin des Nounous et là pour vous !</p> 
    ...
    <hr>
    <p>Vous êtes "Nounou" et souhaitez vous faire connaître, n'hésitez pas créer votre profil juste <a href="index.php?action=newNounouForm">ici</a>.</p>
    <hr>
    <p>Pour plus de précisions, des questions ou petit coucou, n'hésitez pas à <a href="index.php?action=newNounouForm">nous contacter</a>.</p>
</div>
